...
EnumerationStringAssociation association [PACKET_TYPE_COUNT] = {
	...
	associate(CZ_MOVE_CAMP),
	associate(CZ_CAMPINFO),
	associate(ZC_CAMPINFO),
	...
	associate(CZ_DISPEL_DEBUFF_TOGGLE),
	...
	associate(CZ_DOUBLE_ITEM_EQUIP),
	...
	associate(CZ_SWAP_ETC_INV_CHANGE_INDEX),
	...
	associate(ZC_SKILL_RANGE_DONUTS),
	associate(ZC_TEAMID),
	associate(ZC_PC),
	associate(CZ_LOG),
	...
	associate(CZ_BUY_AUTOSELLER_ITEMS),
	associate(CZ_SELL_MY_AUTOSELLER_ITEMS),
	...
	associate(CZ_ACCEPT_PARTY_MISSION),
	associate(CZ_PING),
	associate(ZC_PING),
	associate(ZC_HACKSHIELD_BUFFER),
	associate(CZ_HACKSHIELD_BUFFER),
	associate(CZ_CHANGE_TITLE),
	associate(CZ_PC_COMMENT_CHANGE),
	associate(CZ_AUTTOSELLER_BUYER_CLOSE),
	associate(CZ_REQ_ITEM_LIST),
	associate(CZ_HIT_MISSILE),
	associate(CZ_I_NEED_PARTY),
